# nvim-treesitter-queries-pymanifest

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pymanifest/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pymanifest/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pymanifest**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pymanifest",
...
- [ ] Changes are scoped to `pymanifest` — do not include files for other languages
